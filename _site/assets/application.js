...
(function() {
    ...
    alignElements: function() {
      ...
      $('[data-halign-from]').each(function() {
        if ($(window).width() >= $(this).attr('data-halign-from')) {
          return that.horizontalAlign(this);
        } else {
          return that.horizontalAlignClear(this);
        }
      });
  ...
  Stencil.Tooltip = {
    ...
    init: function(options) {
      ...
      $("[" + this.settings.tooltipAttribute + "]").tooltip({
        trigger: 'manual'
      });
      that = this;
      $("[" + this.settings.tooltipAttribute + "]").on('click', function() {
        $("[" + that.settings.tooltipAttribute + "]").tooltip('destroy');
        return $(this).tooltip('show');
      });
      return $("[" + this.settings.tooltipAttribute + "]").on('mouseover', function(event) {
        $("[" + that.settings.tooltipAttribute + "]").tooltip('destroy');
        return $(this).tooltip('show');
      });
    }
